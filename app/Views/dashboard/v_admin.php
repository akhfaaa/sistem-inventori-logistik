...
<!-- Kontainer utama dashboard admin -->
<div class="max-w-[1400px] mx-auto px-6 py-8">
    <!-- Bagian judul halaman dan deskripsi -->
    <div class="mb-10">
    ...
    <!-- Grid utama untuk menyusun panel informasi -->
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <!-- Panel status inti sistem (Core Status) -->
        <div class="lg:col-span-8 bg-slate-900 p-8 rounded-[2rem] text-slate-300 shadow-xl border border-slate-800 flex flex-col justify-between font-mono">
            <div class="flex justify-between items-start mb-10">
                <!-- Label status sistem (menandakan ONLINE) -->
                <div>
            ...
            <!-- Kartu metrik sistem (Environment, Database, Integrity) -->
            <div class="grid grid-cols-3 gap-4 border-t border-slate-800 pt-6">
                <!-- Info versi PHP yang digunakan -->
                ...
                <!-- Info ping/latensi koneksi ke database -->
                <div class="bg-slate-800/50 p-4 rounded-xl border border-slate-700/50">
                ...
                <!-- Status hasil pemeriksaan integritas sistem -->
                <div class="bg-slate-800/50 p-4 rounded-xl border border-slate-700/50">
        ...
        <!-- Ringkasan jumlah akun sistem yang terdaftar -->
        <div class="lg:col-span-4 bg-white p-8 rounded-[2rem] border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col justify-between">
            <div>
                ...
                <!-- Menampilkan total akun pengguna -->
                ...
                <!-- Tautan menuju halaman manajemen pengguna dan hak akses (RBAC) -->
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <?php if (!empty($logs)): foreach ($logs as $log): ?>
                    <div class="flex gap-4 p-4 bg-slate-50 rounded-xl border border-slate-100 hover:border-slate-300 transition-colors">
                        ...
                        <!-- Menampilkan detail aktivitas, waktu, dan modul terkait -->
                        <div>
                ...
                <?php endforeach; else: ?>
                    <!-- Tampilan default jika belum ada aktivitas yang terekam dalam sistem -->
